 ...
 */
@component
export class Toggle extends VisualElement implements Toggleable {
  @input
  ...
  protected createDefaultVisual(): void {
    if (!this._visual) {
      ...
      defaultVisual.shouldScale = true
      defaultVisual.hoverScale = DEFAULT_SCALE_AMOUNT
      defaultVisual.activeScale = DEFAULT_SCALE_AMOUNT
