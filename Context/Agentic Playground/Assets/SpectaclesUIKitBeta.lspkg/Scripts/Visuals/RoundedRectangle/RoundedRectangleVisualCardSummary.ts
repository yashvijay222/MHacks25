...
const BACKGROUND_GRADIENT_PARAMETERS: {[key: string]: GradientParameters} = {
  default: {
    enabled: true,
    type: "Rectangle",
    stop0: {enabled: true, percent: 0, color: COLORS.lightBlue.uniformScale(1.3)},
    stop1: {enabled: true, percent: 0.5, color: COLORS.lightBlue},
    stop2: {enabled: true, percent: 0.95, color: COLORS.lightBlue},
    stop3: {enabled: true, percent: 0.99, color: COLORS.lightBlue}
  },
  toggled: {
    enabled: true,
    type: "Rectangle",
    stop0: {enabled: true, percent: -1, color: withAlpha(COLORS.lightBlue.uniformScale(0.3), 1)},
    stop1: {enabled: true, percent: -1, color: withAlpha(COLORS.lightBlue.uniformScale(0.3), 1)},
    stop2: {enabled: true, percent: -1, color: withAlpha(COLORS.lightBlue.uniformScale(0.3), 1)},
    stop3: {enabled: true, percent: 3, color: withAlpha(COLORS.lightBlue.uniformScale(0.9), 1)}
  }
}
 ...
 * @extends Visual
 */
export class RoundedRectangleVisualCardSummary extends Visual {
